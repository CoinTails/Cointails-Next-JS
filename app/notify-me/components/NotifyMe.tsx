      ...
      w-[100vw] mx-auto h-[100vh] overflow-hidden z-10">
        <div className="flex flex-col justify-start  lg:px-40
         md:justify-between w-full md:w-[60%] md:max-w-[60%] h-[100vh] px-4 py-4 md:py-10">
          ...
          <div className="rounded-xl mt-4  sm:px-8 p-4 sm:p-4 flex flex-col justify-center items-center">
            ...
            <Button
              ...
              className="block rounded-full leading-[0.25rem]  text-center py-6 sm:py-8 px-8 sm:px-12"
            >
              NOTIFY ME !
            </Button>
          </div>
