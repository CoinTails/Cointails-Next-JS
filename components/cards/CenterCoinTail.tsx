...
const CenterCoinTail: React.FC<ImageComponentProps> = ({
  ...
  return (
    ...
    <div className= "flex flex-col items-center justify-between  ">
              ...
              <div className="transform sm:scale-110 rounded-full pt-4 flex bg-transparent bg-[#eee]  my-0">        
                <Image className={`transform scale-110 ${screenHeight <600?'h-10':'h-28'} w-28 sm:w-52`} src={coinLogoSrc} alt=" Coin Logo" /> &nbsp; &nbsp;
                <Image className={`${screenHeight <600?'h-10'  :'h-28'} w-28 sm:w-52`} 
